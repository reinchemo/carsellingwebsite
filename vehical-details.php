...
if($lastInsertId)
{
echo "<script>alert('Buying successfull.');</script>";
}
else 
{
...
<section class="listing-detail">
  <div class="container">
    <div class="listing_detail_head row">
      <div class="col-md-9">
        <h2><?php echo htmlentities($result->BrandName);?> </h2>
      </div>
      <div class="col-md-3">
        <div class="price_info">
          <p>4,000,000 </p>shillings
        ...
        <div class="listing_more_info">
          <div class="listing_detail_wrap"> 
            ...
            <ul class="nav nav-tabs gray-bg" role="tablist">
              ...
              <a href="#accessories" aria-controls="accessories" role="tab" data-toggle="tab">Accessories</a></li>
      ...
      <aside class="col-md-3">
        ...
        <div class="sidebar_widget">
          <div class="widget_heading">
            <h5><i class="" aria-hidden="true">
              <p>Select the dates that you are ready for deliveries</p>
            </i></h5>
          </div>
          <form method="post">
        ...
        <div class="col-md-3 grid_listing">
          <div class="product-listing-m gray-bg">
            ...
            <div class="product-listing-content">
              ...
              <p class="list-price">3,000,000</p>
