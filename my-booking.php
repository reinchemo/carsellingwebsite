    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          <h5 class="uppercase underline">My Purchasing </h5>
...
<li>
                ...
                { ?>
                <div class="vehicle_status"> <a href="#" class="btn outline btn-xs active-btn">sold</a>
 ...
 <div class="vehicle_status"> <a href="#" class="btn outline btn-xs">Not Confirm yet</a>
            <div class="clearfix"></div>
                ...
                <?php } ?>
       <div style="float: left"><p><b>Message:

       </b> 
       <p>Offer Accepted </p></div>
              </li>
              <?php }} ?>
