...
<section class="section-padding gray-bg">
  <div class="container">
    <div class="section-header text-center">
      ...
      <p>There are many variations of passages of Cars available, but the majority have suffered alteration in some form, by injected humour, or randomised words which don't look even slightly believable. If you are going to use a passage of one, you need to be sure there isn't anything embarrassing hidden in the middle of text.</p>
    </div>
    <div class="row"> 
...
<!-- three -->
</i><?php echo htmlentities($result->ModelYear);?> Model</li>
...
<!-- 
        <div class="testimonial-m">
          <div class="testimonial-img">
             <img src="assets/images/cat-profile.png" alt="" /> </div>
